...
const url="mongodb://siri:siri@cluster0-shard-00-00-4pvi0.mongodb.net:27017,cluster0-shard-00-01-4pvi0.mongodb.net:27017,cluster0-shard-00-02-4pvi0.mongodb.net:27017/test?ssl=true&replicaSet=Cluster0-shard-0&authSource=admin&retryWrites=true&w=majority";
var dbo
 ...
 dbo.collection("studentid").find({gyear:request.body.gyear,gbranch:request.body.gbranch}).toArray((error,res)=>{
   ...
   const transport = nodemailer.createTransport({
    ...
    service: 'gmail',
     ...
     auth: {
        user: 'ankamsireesha468@gmail.com',
        pass: 'sireesha68@',
     }

   });
       const mailOptions = {
     from: '<ankamsireesha468@gmail.com>',
  ...
  console.log(`message CSCsend: ${info.response}`);
